...
/**
 * Sending emails to selected entities
 * 
 * This works for any node operational action
 * 
 * @Action(
 *   id = "send_emails_to_selected_entities",
 *   label = @Translation("Sending email actions"),
 *   type = "node"
 * )
 */
final class SendEmail extends ConfigurableActionBase implements ContainerFactoryPluginInterface
{
    ...
    {
        $entity->field_email_status->target_id = $this->configuration['email_status'];
        try {
            $entity->save();
    ...
    public function buildConfigurationForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['email_status'] = [
            ...
            '#default_value' => $this->configuration['email_status'],
            '#options' => $options,
            '#required' => TRUE,
        ];
        return $form;
    ...
    {
        $this->configuration['email_status'] = $form_state->getValue('email_status');
    }
}
